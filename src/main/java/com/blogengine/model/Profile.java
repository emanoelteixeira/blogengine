...
@Table(name = "profiles")
@NamedQueries({
    @NamedQuery(name = "Profile.findByProfileName", query = "select p from Profile p where p.name = :name "),
    @NamedQuery(name = "Profile.findByProfileEmail", query = "select p from Profile p where p.email = :email ")
})
